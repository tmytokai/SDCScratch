...
//            twgl.getContext(canvas, contextAttribs);
    ...
    constructor (canvas, xLeft, xRight, yBottom, yTop) {
        ...
        // added by tmytokai
        // A list of background's drawableID
        /** @type {Array<int>} */
        this._bgDrawList = [];
	...
	this._drawBackground = false;
        this._bgDrawList.forEach( id => this.updateDrawableVisible(id,false) );
    }
    ...
    _addToDrawList (drawableID, group) {
        ...
        // added by tmytokai
        if(group == 'background'){
            this._bgDrawList.push(drawableID);
        }
    }
    ...
    updateDrawableVisible (drawableID, visible) {
        ...
        // added by tmytokai
        if( !this._drawBackground && this._bgDrawList.includes(drawableID) ){
            visible = false;
        }
