...
class Runtime extends EventEmitter {
    constructor () {
        ...
        // added by tmytokai
        // A reference set by `requestAnimationFrame`
        /** @type {!number} */
        this._steppingAnimationFrame = null;
    ...
    // added by tmytokai
    // use animation frame instead of interval timer
    _stepAnimationFrame () {
        this._step();
        this._steppingAnimationFrame = requestAnimationFrame( ()=>this._stepAnimationFrame() );
    }
    startAnimationFrame () {
        if (this._steppingAnimationFrame) return;
        if (this._steppingInterval) {
            clearInterval(this._steppingInterval);
            this._steppingInterval = null;
        }
        this.renderer.unsetDrawBackground();
        this._stepAnimationFrame ();
    }
